...
//   // 🔹 API URL from environment variable (fallback for when env is missing)
...
//   // 🔹 Refetch when admin adds/edits/deletes products
//   useEffect(() => {
...
function ProductList() {
  ...
  // 🔹 API URL from environment variable only (no fallback)
